...
export function PlayerCard({ player }: { player: Player }) {
  ...
  return (
    <div
      ...
      // TouchSensor's drag recognition on phones.
      className={
        'touch-none select-none truncate rounded bg-white px-2 py-1.5 text-sm shadow-sm ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700 ' +
